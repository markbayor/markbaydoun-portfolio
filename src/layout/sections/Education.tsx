      ...
      <ul className='edu__list'>
        <li className="edu__item">
          ...
          <div className="edu__item-content">
            <h4 className='edu__title'>Fullstack Academy <span>Jan 2020 - July 2020</span></h4>
        ...
        <li className="edu__item">
          ...
          <div className="edu__item-content">
            <h4 className='edu__title'>EAE Business School <span>2017 - 2021</span></h4>
            <div className="edu__description">
        ...
        <li className="edu__item">
          ...
          <div className="edu__item-content">
            <h4 className='edu__title'>Pace University <span>2019 - 2020</span></h4>
            <div className="edu__description">
